...
class _MainPageState extends State<MainPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      backgroundColor: Colors.teal,//_themeProv.lightTheme ? Colors.white : Colors.black,
      appBar: appBar,
  ...
  Widget _appBarTabDesktop(ThemeProvider _themeProv) {
    return AppBar(
      elevation: 0.0,
      backgroundColor: Colors.black38,//_themeProv.lightTheme ? Colors.white : Colors.black,
  ...
  Widget _appBar(ThemeProvider _themeProv) {
    return AppBar(
