...
// Colors
const Color kPrimaryColor = Color(0xff1b4332);
...
final kProjectsBanner = [
  "assets/projects/MuktoMart.png",
  "assets/projects/Deub.png",
  "assets/projects/CheatNinja.jpg",
  //"assets/projects/covidB.png",
];

final kProjectsIcons = [
  "assets/projects/mukto_mart_logo.png",
  "assets/projects/deub_logo.png",
  "assets/projects/cheat_ninja_logo.png",
...
final kProjectsDescriptions = [
  "A business E-Commerce app fully developed by me using Flutter Connected with rest api as backend & used provider as state management.Also used SQLite database.Get it on google play store.",
  "A flutter app 80% developed by me where users can buy product, earn by watching advertisements & referring other users. Powered with firebase as backend database & GetX as state management",
  "A game related E-commerce app fully developed by me using wordPress rest api and firebase database as backend and also used firebase push notifications for sending notifications from admin.",
...
final kProjectsLinks = [
  "https://play.google.com/store/apps/details?id=com.muktomart.mukto_mart",
  "https://github.com/Ashfaqanik/Mak-B",
  "https://github.com/Ashfaqanik/CheatNinja",
